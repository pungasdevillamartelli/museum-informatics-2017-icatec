...
function requestHandler(req, res) {	
	...
	if (pathname == "/viewShaderVariation")
	...
	else if (pathname == "/getLastClick")
		db.getLastClick(res, req, arguments);
	...
	else if (pathname == "/registerClick")
		db.clickedOn(res, req, arguments);
	...
	else if (pathname == "/clickedOn")
		db.clickedOn(res, req, arguments);	
	else if (pathname == "/addShaderEntity")
		db.registerShaderEntity(res, arguments);	
	else if ((pathname == "/editor-museum-debug.html") || (pathname == "/editor-museum.html") || (pathname == "/editor.html"))
